...
func (coll *Collection) DeleteWithFilter(ctx context.Context, filter interface{}, opts ...*options.DeleteOptions) error {
	return delMany(ctx, coll, filter, opts...)
}
